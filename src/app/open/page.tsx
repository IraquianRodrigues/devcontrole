...
// criar nosso objeto de validação
...
export default function OpenTicket(){
    ...
    // quando clicar no "X", zerar a usestate
    function handleClearCustomer(){
        setCustomer(null)
        setValue("email", "")
    }

    //função para fazer a busca por email
    async function handleSearchCustomer(data: FormData){
        ...
        if(response.data === null){
            setError("email", {type: "custom", message:"Ops, cliente não localizado :("})
            return
        }
