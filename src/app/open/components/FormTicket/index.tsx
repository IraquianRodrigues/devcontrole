...
const schema = z.object({
    ...
    description: z.string().min(1, "Descreve o seu problema")
})
...
export function FormTicket({customer}: FormTicketProps){
    ...
    return(
        ...
        <label className="mb-1 font-medium text-lg">Descreva o problema:</label>
         <textarea className="w-full border-2 rounded-md h-24 resize-none px-2" placeholder="Descreva o seu problema" id="description"
